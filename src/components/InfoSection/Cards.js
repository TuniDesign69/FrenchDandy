...
function Cards() {
  ...
  return (
    <div className="Cards" className={style.Container}>
      ...
      <div className="row" className={style.Events}>
        <div className={style.EventInfo}>
          ...
          <div className={style.div_text} >
            ...
            <div className="row">
              <div className="col-md-4 col-sm-4"><span></span></div>
              <div className="col-md-4 col-sm-4"><span>At</span></div>
            </div>

            <div className="row">
            <div className="col-md-4 col-sm-4"><span></span></div>
              <div className="col-md-4 col-sm-4"><span>CARTIER'S</span></div>
        
            </div>
            <div className="row">
            <div className="col-md-4 col-sm-4"><span></span></div>
              <div className="col-md-4 col-sm-4"><span>EVENT</span></div>
              
            </div>
            <div className="row">
            <div className="col-md-2 col-sm-4"><span></span></div>
            <div className="col-md-8 col-sm-8"><p>Such an amazing event</p></div>
         
            </div>

          </div>

          {/* <h1 className={style.imgCARTIER}   style={{textAlign:"center" }}>AT CARTIER'S</h1>
<h1 style={{padding:"0 0 0 34%" }}>EVENT</h1>
<p  style={{color:"white" ,fontSize:'120%',padding:"0.5% 0 2% 37%"}}>Such an amazing event</p> */}
      ...
      <div className={style.Events}>
        <div className={style.EventInfo2} className={style.EventInfo2IMG}>

          <h1 className="h1is" style={{ fontSize: "400%", paddingTop: "400px" }}>PARIS FASHION</h1>
